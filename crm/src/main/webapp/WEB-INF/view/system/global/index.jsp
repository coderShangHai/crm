<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<style type="text/css">
.crm_system_global table {width:100%;}
.crm_system_global table input{height:32px !important;width:150px !important;}
.crm_system_global fieldset{border:1px solid #d4d4d4;border-radius:5px;}
.crm_system_global .up{background:url(${pageContext.request.contextPath}/images/up.png) no-repeat center center;display: block;width: 20px;height: 20px;float: left;}
.crm_system_global .down{background:url(${pageContext.request.contextPath}/images/down.png) no-repeat center center;display: block;width: 20px;height: 20px;float: left;}
.crm_system_global legend {cursor:pointer;}
.crm_system_global table input[type='radio']{width:17px !important;height:17px !important;}
.crm_system_global div a{height:30px;width:90px;margin-top:10px;}
.crm_system_global div a .l-btn-text{line-height:28px;}
</style>
...
<div class="crm_system_global" id="crm_system_global_main_div">
	<fieldset>
	    ...
	    <table>
	    	...
	    	<tr>
	    		...
	    		<td>网址:</td>
	    		<td colspan="3">
	    			<input style="width:420px !important" class="easyui-textbox" name="url" value="http://www.fxeie.com"/>
	    		</td>
	    	</tr>
	    	<tr>
	    		<td>中文地址:</td>
	    		<td colspan="2">
	    			<input style="width:220px !important" class="easyui-textbox" name="chinaAddress" value="Unit 46 Cariocca business park 2 Sawley road miles platting Manchester"/>
	    		</td>
	    		<td>英文地址:</td>
	    		<td colspan="2">
	    			<input style="width:220px !important;" class="easyui-textbox" name="englishAddress" value="Unit 46 Cariocca business park 2 Sawley road miles platting Manchester"/>
	    		</td>
	    	</tr>
	    </table>
	</fieldset>
	    	...
	    	<tr>
	    		...
	    		<td>
					<select class="easyui-combobox" name="sex" style="width:150px;height:32px;">
						<option value="" selected="selected">美金</option>
	...
	<div style="width:100%;text-align:right;">
		...
		<a name="upload" style="margin-left:10px;" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-upload'">上传标志</a>
