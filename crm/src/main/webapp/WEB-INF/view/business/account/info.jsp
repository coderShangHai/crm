<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/buiness/account/info.js"></script>
<style type="text/css">
.crm_system_function input[type='text'] {width:180px !important;}
.crm_system_function table.history td:nth-child(odd){width:70px;}
.img_list {margin-top:8px;}
.img_list img{max-width:180px;max-height:180px;margin-left:10px;}
</style>
<div class="easyui-accordion" style="width:100%;height:98%;" id="crm_account_info">
	...
	<div title="银行卡与证件" data-options="iconCls:'icon-help'">
		<div class="btn_div" style="width:100%;height:40px;">
			<div style="float:right;">
				<a name="add" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add'">添加银行卡</a>
				<a name="delete" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-remove'">删除</a>
				<a name="refresh" class="refresh"></a>
			</div>
		</div>
		<div name="list">
			<div id="crm_account_bank_list" style="overflow:hidden;width:100%;height:100%;"></div>
		</div>	
		<div class="img_list">
			<img alt="" src="/images/test/idCard_1.jpg">
			<img alt="" src="/images/test/idCard_2.jpg">
		</div>
	</div>
</div>
