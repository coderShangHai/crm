...
<style type="text/css">
.crm_menu_footer,.crm_menu_header {height:30px !important;border-width:0px;border-bottom: 1px solid #d4d4d4;width:100%;}
.crm_menu_footer a,.crm_menu_header a{display: block;width: 24px;border-right:1px solid #d4d4d4;height: 16px;float: left;margin-left: 10px;cursor: pointer;margin-top: 6px;}
.crm_menu_footer a:nth-child(1){background:url(${pageContext.request.contextPath}/images/home.png) no-repeat;}
.crm_menu_footer a:nth-child(2){background:url(${pageContext.request.contextPath}/images/phone-message.png) no-repeat;}
.crm_menu_footer a:nth-child(3){background:url(${pageContext.request.contextPath}/images/email.png) no-repeat;border-right:0px;}

.crm_menu_header a:nth-child(1){background:url(${pageContext.request.contextPath}/images/person.png) no-repeat;}
.crm_menu_header a:nth-child(2){background:url(${pageContext.request.contextPath}/images/login.png) no-repeat;border-right:0px;}
.crm_menu_header a:nth-child(3){background:url(${pageContext.request.contextPath}/images/exit.png) no-repeat;border-right:0px;float:right !important;}
			...
			<div title="系统管理" data-options="iconCls:'icon-system'" style="overflow:auto;padding:10px;">
				<ul class="easyui-tree" id="mt4_crm_system_tree">
					<li>
						<span>系统设置</span>
						<ul>
							<li><a data-model="window" data-url="${pageContext.request.contextPath}/global/index">全局配置</a></li>
							<li><a data-model="window" data-url="${pageContext.request.contextPath}/mt4/index">MT4 组管理</a></li>
							<li><a data-model="window" data-url="${pageContext.request.contextPath}/function/index">功能配置</a></li>
							<li><a data-model="tab" data-url="${pageContext.request.contextPath}/protocol/index">协议设置</a></li>
						</ul>
					</li>
					<li>
						<span>工单系统</span>
						<ul>
							<li><a data-model="tab" data-url="${pageContext.request.contextPath}/consult/index">站内查询</a></li>
						</ul>
					</li>
				</ul>
			</div>
			<div title="业务管理" data-options="iconCls:'icon-business'" style="padding:10px;">
				<ul class="easyui-tree" id="mt4_crm_buiness_tree">
					<li>
						<span>业务处理</span>
						<ul>
							<li><a data-model="tab" data-url="${pageContext.request.contextPath}/account/index">账户审核</a></li>
							<li>入金审核</li>
							<li>出金审核</li>
						</ul>
					</li>
